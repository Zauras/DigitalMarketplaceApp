    ...
    <div>
        ...
        <ul>
            ...
            <li>
                ...
                automatically, so your client-side resources are dynamically built on demand and the
                page refreshes when you modify any file.
            </li>
            <li>
        ...
        <p>
            The <code>ReactApp</code> subdirectory is a standard React application based on the{' '}
